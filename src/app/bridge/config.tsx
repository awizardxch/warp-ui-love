...
const TIGER_BLOOD_MEMECOIN_ASSET_ID_MAINNET = '95430751e3894b48820b7da497f04abd0e46fe6d982fa98daf174ff1e35159bd'
const TIGER_BLOOD_MEMECOIN_ADDRESS_BASE_MAINNET = '0xD999c5E89018a28deA05607837DD5DD6de26d907'

export const TIGER_BLOOD_MEMECOIN_TOKEN_BASE_ONLY: Token = {
  symbol: '🐯🩸',
  getSpecificSymbol: makeCoinsetNativeToken('🐯🩸'),
  sourceNetworkType: NetworkType.COINSET,
  supported: [
    {
      evmNetworkId: BASE_NETWORK.id,
      coinsetNetworkId: CHIA_NETWORK.id,
      assetId: TIGER_BLOOD_MEMECOIN_ASSET_ID_MAINNET,
      contractAddress: TIGER_BLOOD_MEMECOIN_ADDRESS_BASE_MAINNET
    },
  ],
  memecoin: true,
  additionalWarning: null,
...
const UFO_MEMECOIN_ASSET_ID_MAINNET = 'cb0ede34fda366f9733f602c82ecf5c5e00f0710bf5a03e40afe54239eca6ccd'
const UFO_MEMECOIN_ADDRESS_BASE_MAINNET = '0x4bfFe8111138513EC0BeF615eD3D05aCf4D76596'

export const UFO_MEMECOIN_TOKEN_BASE_ONLY: Token = {
  symbol: '🛸',
  getSpecificSymbol: makeCoinsetNativeToken('🛸'),
  sourceNetworkType: NetworkType.COINSET,
  supported: [
    {
      evmNetworkId: BASE_NETWORK.id,
      coinsetNetworkId: CHIA_NETWORK.id,
      assetId: UFO_MEMECOIN_ASSET_ID_MAINNET,
      contractAddress: UFO_MEMECOIN_ADDRESS_BASE_MAINNET
    },
  ],
  memecoin: true,
  additionalWarning: null,
...
const COLA_MEMECOIN_ADDRESS_BASE_MAINNET = '0x04916222711e06FA3a312503843F1Df68465Dd46' //COLA 0x89062c32a74BFF97Bd9c0312027755c755bE3833
0x04916222711e06FA3a312503843F1Df68465Dd46
